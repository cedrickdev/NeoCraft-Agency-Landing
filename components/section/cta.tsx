    ...
    return (
        <section className="py-32 relative overflow-hidden">
            <div className="absolute inset-0 -z-10">
                ...
                <div
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl"></div>
            </div>
                    ...
                    <div className="space-y-8 mb-12">
                        <div className="space-y-6">
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
                                {t('title.h1')}
                                <span
                                    className="block bg-gradient-to-r from-blue-600 to-emerald-500 bg-clip-text text-transparent">
                                    {t('title.span')}
                </span>
                            </h2>
                        ...
                        {/* Stats */}
                        <div className="grid grid-cols-4 gap-8 max-w-2xl mx-auto py-8">
