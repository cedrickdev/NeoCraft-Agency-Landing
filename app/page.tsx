          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Conçu avec une approche réfléchie, nous mettons en pratique ce
                que nous prêchons. Le résultat est un site web accessible à
                tous, qui se charge en un clin d’œil et qui minimise la quantité
                de carbone émise à chaque chargement de page
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Des services complets pour accompagner votre transformation
              digitale et vous aider à atteindre vos objectifs.
            </p>
          </motion.div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-800">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-6">
                    ...
                    vous aider à le concrétiser avec notre expertise technique.
                  </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-center md:text-left">
                © 2025 NeoCraft. Tous droits réservés.
              </p>
