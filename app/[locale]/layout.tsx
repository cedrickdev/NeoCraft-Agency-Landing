...
export default async function LocaleLayout({children, params}: Props) {
    ...
    const jsonLd = {
        ...
        "foundingLocation": "lausanne, Switzerland",
        "slogan": "Votre partenaire digital de confiance",
        "description": `${messages.Seo.jsonLd.description} - Entreprise en cours de création`,
        "knowsAbout": ["Développement web", "Applications mobiles", "Solutions digitales"],
        "contactPoint": {
            "@type": "ContactPoint",
            "email": "mailto:support@neocraft.dev",
            "telephone": "+41 77 807 88 06",
